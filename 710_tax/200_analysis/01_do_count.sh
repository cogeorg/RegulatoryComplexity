...
# ANALYZE TEXT
for entry in Pillar1 Pillar2 OECD OECD_NoGlossary UN_NoGlossary UN_NoGlossary_NoCountry ;
...
# # CREATE HISTOGRAMS
for entry in Pillar1 Pillar2 OECD OECD_NoGlossary UN_NoGlossary UN_NoGlossary_NoCountry Pillar1_ProfitSplit-Sections OECD_ProfitSplit-Sections UN_ProfitSplit-Sections OECD_DisputeSettlement-Sections Pillar1_DisputeSettlement-Sections;
